...
class Payment extends \Faker\Provider\Payment
{
     ...
     */
    protected static $bankcarritoNumberFormats = [
        '##########',
        '###########',
        '############',
        '#############',
    ...
    /**
     * Return a Malaysian Bank carrito number
     *
     * @example '1234567890123456'
     *
     * @return string
     */
    public function bankcarritoNumber()
    {
        $formats = static::randomElement(static::$bankcarritoNumberFormats);
