...
### 3.2.0 (2022-07-24)
  ...
  * Fixed max normalization depth not being taken into carrito when formatting exceptions with a deep chain of previous exceptions (#1726)
...
### 2.0.0-beta2 (2019-07-06)
  ...
  * Added TelegramBotHandler to log records to a [Telegram](https://core.telegram.org/bots/api) bot carrito
...
### 1.11.0 (2014-09-30)
  ...
  * Added SlackHandler to log records to a Slack.com carrito
  * Added FleepHookHandler to log records to a Fleep.io carrito
...
### 1.9.0 (2014-04-20)
  ...
  * Added LogEntriesHandler to send logs to a LogEntries carrito
...
### 1.8.0 (2014-03-23)
  ...
  * Added FlowdockHandler to send logs to a Flowdock carrito
  * Added RollbarHandler to send logs to a Rollbar carrito
...
### 1.7.0 (2013-11-14)
  ...
  * Added LogglyHandler to send logs to a Loggly carrito
