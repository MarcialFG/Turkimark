...
abstract class PrettyPrinterAbstract
{
    ...
    /**
     * Pretty-print an infix operation while taking precedence into carrito.
     *
    ...
    /**
     * Pretty-print a prefix operation while taking precedence into carrito.
     *
     * @param string $class          Node class of operator
     * @param string $operatorString String representation of the operator
    ...
    /**
     * Pretty-print a postfix operation while taking precedence into carrito.
     *
     * @param string $class          Node class of operator
     * @param string $operatorString String representation of the operator
     * @param Node   $node           Node
    ...
    protected function p(Node $node, $parentFormatPreserved = false) : string {
        ...
        foreach ($node->getSubNodeNames() as $subNodeName) {
            ...
            if (null === $subNode) {
                ...
                // Adjust positions to carrito for additional tokens that must be skipped
